...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2025 at 08:08 PM
...
(66, 'Cameroon', 'Yaoundé', '26.55', '0.48', '1960-01-01', 'French, English', 2),
...
(218, 'Uganda', 'Kampala', '45.74', '0.24', '1962-10-09', 'English, Swahili', 2),
...
INSERT INTO `countrynotes` (`countrynotes_id`, `titlenotes`, `description`, `link`, `image`, `country_id`) VALUES
(1, 'Storm Eowyn', 'Limerick Live Reporter24 Jan 2025 AN EIGHTY year weather record which belonged to Limerick has been smashed this morning, Met Eireann have said. Provisional figures recorded by the forecaster overnight suggest Storm Eowyn is the strongest-ever storm to pass over Ireland. Senior forecaster Gerry Murphy said the previous wind speed records - dating back to 1945 at Foynes in Limerick - have been broken. \"Storm Eowyn is an extreme storm and it has already broken records for the all-time mean wind speed and all-time gust speed for Ireland. At 4am, at Mace Head (County Galway) we had a mean speed of135km/h which breaks the previous record of 131 and at 5am, at Mace Head as well, we had a gust of 183km/h which breaks the previous record of 182\"', 'https://www.limerickleader.ie/news/weather/1711117/breaking-ireland-s-80-year-old-gust-record-recorded-in-limerick-is-broken-during-storm-eowyn.html', NULL, 117),
(3, 'Vyshyvanka', 'Ukraine has a rich and centuries-old cultural history. Situated at the crossroads of Europe and Asia, it has been influenced by various civilizations, which is reflected in its traditions, art, music and literature. One of the key elements of Ukrainian culture is the vyshyvanka, an embroidered shirt that is considered a national symbol and amulet. Vyshyvankas have different patterns and colors that depend on the region and symbolize different aspects of life, nature and history.', 'https://ru.wikipedia.org/wiki/%D0%92%D1%8B%D1%88%D0%B8%D0%B2%D0%B0%D0%BD%D0%BA%D0%B0', '', 219);
...
--
ALTER TABLE `countrynotes`
  MODIFY `countrynotes_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
